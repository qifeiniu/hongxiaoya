    ...
    <view class="header-section">
      <view class="header-banner">
        <view class="balance-info">
          <text class="balance-title">当前鸭蛋</text>
        ...
        <view class="list-item" v-for="(item, index) in filteredList" :key="index">
          ...
          <view class="item-right">
            <template v-if="item.amount && item.amount < 0">
              <text class="item-amount expense">{{ item.amount }}个</text>
            </template>
            <template v-else-if="item.amount && item.amount > 0">
              <text class="item-amount income">+{{ item.amount }}个</text>
            </template>
          </view>
        </view>
      </scroll-view>
